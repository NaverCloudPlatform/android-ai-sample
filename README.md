...
* **Chatbot 대화시나리오 구현** ([Chatbot 퀵스타트 설명서](http://docs.ncloud.com/ko/chatbot/chatbot-1-1.html))
  ...
  - 채널 연동 : 도메인 > 빌더 실행 > 챗봇 설정 > 메신저 연동 > Custom 설정
  - API Gateway 설정 : API Gateway > My Product ([Custom 설정 & API Gateway 설정 설명서](http://docs.ncloud.com/ko/chatbot/chatbot-2-5.html))
  
  <img width="808" alt="default" src="https://user-images.githubusercontent.com/41188783/50975974-27b17480-1532-11e9-9aa3-80d06c0df6b4.png">
